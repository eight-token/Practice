...
namespace dotBunny.Unity
{
    ...
    public static class VSCode
    {
        ...
        static string VsCodePath
        {
            get
            {
                return EditorPrefs.GetString("VSCode_Path", "");
            }
            set
            {
                EditorPrefs.SetString("VSCode_Path", value);
            }
        }
        ...
        static void VSCodePreferencesItem()
        {
            ...
            VsCodePath = EditorGUILayout.TextField(new GUIContent("VS Code Path", "reanisz's patch"), VsCodePath);
        ...
        static string ScrubProjectContent(string content)
        {
            ...
            {
                var idx = content.IndexOf("<TargetFrameworkVersion>v2.0</TargetFrameworkVersion>");
                content = content.Insert(idx, "<TargetFrameworkProfile>Unity Full v3.5</TargetFrameworkProfile>    \n");
            }
